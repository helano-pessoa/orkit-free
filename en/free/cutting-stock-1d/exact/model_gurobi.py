"""1D Cutting Stock -- Compact MIP formulation with gurobipy.

WARNING: Requires a valid Gurobi license.
...
def build_and_solve(
    ...
    """Build and solve compact MIP with Gurobi.

    Args:
        instance: Problem instance.
        verbose: Show Gurobi log if True.
